    ...
    assistantHeader.innerHTML = `
        <div class="assistant-header-content">
            ...
            <div class="assistant-header-text">
                <div class="assistant-header-title">Консультант CantuPneus</div>
                <div class="assistant-header-subtitle">Типоразмеры, наличие по филиалам и условия оплаты.</div>
            </div>
            <div class="assistant-header-actions">
                ...
                <button class="assistant-close-btn" aria-label="Закрыть">
    ...
    assistantContent.innerHTML = `
        <div class="assistant-content-wrapper">
            ...
            <div class="assistant-spotlight-section">
                <span class="assistant-eyebrow">Поддержка</span>
                <h3>Подберите нужный типоразмер вместе с CantuPneus.</h3>
                <p>Смотрите линейки в наличии, рассчитайте полную загрузку или обсудите кредитный лимит с консультантом.</p>
            </div>
