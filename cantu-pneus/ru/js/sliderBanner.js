    ...
    const slides = [
      {
        ...
        alt: 'Седельный тягач на грузовых шинах CantuPneus',
        eyebrow: 'Грузовая линейка',
        title: 'Грузовая линейка: гарантированная оборачиваемость',
        desc: 'Рисунки «ёлочка» и «рёбра» в самых ходовых типоразмерах, с проверкой остатков по каждому складу.',
        cta: 'Смотреть грузовую линейку',
        href: '#collections'
      },
      {
        image: 'images/scenes/operacao-estoque.jpg',
        alt: 'Складской запас шин в распределительном центре',
        eyebrow: 'Операции CantuPneus',
        title: 'Склад импортёра, доставка за 24 часа',
        desc: 'Мы закупаем напрямую с завода и поставляем перевозчикам, дилерам и владельцам автопарков без посредников в цепочке.',
        cta: 'Посмотреть, как мы работаем',
        href: '#collections'
      },
      {
        image: 'images/scenes/linha-agricola.jpg',
        alt: 'Шина для сельскохозяйственного трактора',
        eyebrow: 'Персональное обслуживание',
        title: 'Свяжитесь с консультантом CantuPneus',
        desc: 'Персональный менеджер поможет собрать заказ, проверить наличие по филиалам и открыть кредитный лимит действующим компаниям.',
      ...
      <div class="container">
        <div class="slider-header">
          <div class="slider-header-content">
            <span class="section-subtitle">Хиты недели</span>
            <h2 class="h2 section-title">Хиты складских запасов CantuPneus</h2>
          </div>
          <div class="slider-nav">
            <button class="slider-btn slider-prev" type="button" aria-label="Предыдущий слайд">
              <ion-icon name="chevron-back-outline"></ion-icon>
            </button>
            <button class="slider-btn slider-next" type="button" aria-label="Следующий слайд">
