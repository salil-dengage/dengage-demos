(function () {
    ...
    function renderCard(product) {
        ...
        return ''
            ...
            + '  <a class="product-card-media" href="' + escapeHtml(detailUrl) + '" aria-label="Открыть ' + escapeHtml(product.name) + '">'
            ...
            + '      <a class="btn-primary product-card-view" href="' + escapeHtml(detailUrl) + '">Подробнее</a>'
    ...
    function init() {
        ...
        window.CantuCatalogData.loadProducts()
            .then(function (products) {
                ...
                if (!visible.length) {
                    setStatus(statusEl, 'Нет доступных товаров.');
                    return;
                }
            ...
            .catch(function (error) {
                ...
                setStatus(statusEl, 'Сейчас не удалось загрузить товары.');
            });
    }
