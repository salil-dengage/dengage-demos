...
function carouselBanner() {
  ...
  var defaultSlides = [
    {
      ...
      title: "Грузовая линейка",
      description: "Рисунки «ёлочка», «рёбра» и универсальные для тяжёлой магистрали и разбитых покрытий.",
      alt: "Грузовые шины на складе распределительного центра"
    },
    {
      image: "images/scenes/story-frota.jpg",
      title: "Marshal KLD01 295/80 R22.5",
      description: "Шина Marshal KLD01 295/80 R22.5 с рисунком «ёлочка» в наличии на пяти складах.",
      alt: "Легковая шина CantuPneus"
    },
    {
      image: "images/scenes/linha-agricola.jpg",
      title: "Индустриальная линейка и OTR",
      description: "Для фронтальных погрузчиков, вилочных погрузчиков и техники OTR, с усиленным каркасом для непрерывной работы.",
      alt: "Индустриальные шины и шины OTR"
    },
    {
      image: "images/scenes/linha-carga.jpg",
      title: "Truck Line",
      description: "Персональный менеджер соберёт заказ и проверит наличие по филиалам.",
      alt: "Грузовые шины для тяжёлых условий"
    },
    {
      image: "images/scenes/linha-otr.jpg",
      title: "Statement Pieces",
      description: "Рисунки R1 и R1W для тракторов, комбайнов и навесной техники, в наличии во всех регионах.",
      alt: "Сельскохозяйственные шины"
    },
    {
      image: "images/scenes/linha-agricola.jpg",
      title: "Сельскохозяйственная линейка",
      description: "Рассчитайте полную загрузку, зафиксируйте цену и отслеживайте доставку прямо на портале.",
      alt: "Шины для сельскохозяйственных тракторов"
    }
  ];

  var config = {
    headerTitle: "Хиты недели CantuPneus",
  ...
  function buildSlidesHTML(slides) {
    ...
    return slides
      .map(function (s) {
        var img = s.image || "";
        var alt = s.alt != null ? s.alt : "Хит CantuPneus";
  ...
  function ensureDOM() {
    ...
    overlay.innerHTML =
      ...
      '<button class="cantupneus-carousel-close" aria-label="Закрыть" type="button">&#10005;</button>' +
      '<div class="cantupneus-carousel-header">' + (config.headerTitle || "Хиты недели CantuPneus") + "</div>" +
