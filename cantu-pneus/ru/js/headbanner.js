...
(function () {
    ...
    function initHeadBanner() {
        ...
        banner.innerHTML =
            ...
            '<span class="cantupneus-head-banner-badge">Предложение недели</span>' +
            '<span class="cantupneus-head-banner-title">Неделя дальнобойщика CantuPneus</span>' +
            '<span class="cantupneus-head-banner-text">Особые условия на полную загрузку и доставку CIF в обслуживаемые столицы штатов.</span>' +
            '<a class="cantupneus-head-banner-link" href="#contact">Связаться с консультантом</a>' +
            "</div>" +
            '<button class="cantupneus-head-banner-close" type="button" aria-label="Закрыть">&times;</button>';
