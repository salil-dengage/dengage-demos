...
if (!document.querySelector("#min-bar-container")) {
    ...
    // Неделя дальнобойщика, 25% на грузовую линейку
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "CARRETEIRO25",
      desktopImg: "images/scenes/hero-carga.jpg",
      mobileImg: "images/scenes/hero-carga.jpg",
      title: "Неделя дальнобойщика",
      subtitle: "Скидка 25% на грузовую линейку всю неделю.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      ...
      subtitle: "Скидка 20% на самые ходовые типоразмеры для зарегистрированных автопарков.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      ...
      subtitle: "Доставка CIF включена при заказе 72 шин Marshal KLD01.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      ...
      subtitle: "Проверка DOT и распределение по складам без доплаты.",
      href: null,
    });

    let MIN_BAR_CONFIG = [
      { text: "✦ CantuPneus Exclusive Offers", href: null, isInitMaxBar: true },
      { text: "Неделя дальнобойщика: скидки до 25%", href: null, isInitMaxBar: true },
      { text: "Доставка CIF при заказе полной загрузки", href: null, isInitMaxBar: true },
    ];
