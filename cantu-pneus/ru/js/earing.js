function earingWidget() {
    ...
    const config = {
        ...
        menuItems: [
            { text: "Открыть каталог", url: "#collections" },
            { text: "Хиты грузовой линейки", url: "#collections" },
            { text: "Qualidade", url: "#craftsmanship" },
            { text: "Наша история", url: "#story" },
            { text: "Связаться с консультантом", url: "#contact" }
        ],
        tabText: "Консультант CantuPneus",
