...
if (loginForm) {
   loginForm.addEventListener('submit', event => {
      ...
      if (firstInvalidInput) {
         setSignupError('Заполните все поля, чтобы продолжить.');
      ...
      try {
         ...
         console.error('Не удалось сохранить данные пользователя в localStorage', err);
      }
