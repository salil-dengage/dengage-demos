    ...
    const slides = [
      {
        ...
        alt: 'Carreta equipada com pneus de carga CantuPneus',
        eyebrow: 'Linha Carga',
        title: 'Linha Carga: giro garantido',
        desc: 'Borrachudos e lisos direcionais das medidas de maior giro, com estoque conferido por centro de distribuição.',
        cta: 'Ver linha Carga',
        href: '#collections'
      },
      {
        image: 'images/scenes/operacao-estoque.jpg',
        alt: 'Estoque de pneus no centro de distribuição',
        eyebrow: 'Operação CantuPneus',
        title: 'Estoque de importador, entrega em 24 horas',
        desc: 'Compramos direto da fábrica e entregamos ao transportador, à revenda e ao frotista sem intermediários no caminho.',
        cta: 'Conhecer a operação',
        href: '#collections'
      },
      {
        image: 'images/scenes/linha-agricola.jpg',
        alt: 'Pneu agrícola de trator',
        eyebrow: 'Atendimento dedicado',
        title: 'Fale com um consultor CantuPneus',
        desc: 'Consultor dedicado para montar o pedido, conferir disponibilidade por filial e liberar crédito para CNPJ ativo.',
        ...
        <div class="banner-slide">
          ...
          <div class="banner-overlay">
            <div class="banner-text">
              ...
              <a class="banner-cta" href="${slide.href}" data-widget="Destaques CantuPneus" data-slide="${slide.title}">
                ${slide.cta}
      ...
      <div class="container">
        <div class="slider-header">
          <div class="slider-header-content">
            <span class="section-subtitle">Destaques da semana</span>
            <h2 class="h2 section-title">Destaques do estoque CantuPneus</h2>
          </div>
          <div class="slider-nav">
            <button class="slider-btn slider-prev" type="button" aria-label="Slide anterior">
              <ion-icon name="chevron-back-outline"></ion-icon>
            </button>
            <button class="slider-btn slider-next" type="button" aria-label="Próximo slide">
      ...
      cta.addEventListener('click', function() {
        ...
        if (typeof window.dataLayer !== 'undefined') {
          window.dataLayer.push({
            ...
            widgetName: 'Destaques CantuPneus Slider',
