(function () {
    ...
    function renderCard(product) {
        ...
        return ''
            ...
            + '  <a class="product-card-media" href="' + escapeHtml(detailUrl) + '" aria-label="Ver ' + escapeHtml(product.name) + '">'
            ...
            + '      <a class="btn-primary product-card-view" href="' + escapeHtml(detailUrl) + '">Ver detalhes</a>'
    ...
    function init() {
        ...
        window.CantuCatalogData.loadProducts()
            .then(function (products) {
                ...
                if (!visible.length) {
                    setStatus(statusEl, 'Nenhum produto disponível.');
                    return;
                }
            ...
            .catch(function (error) {
                ...
                setStatus(statusEl, 'Não foi possível carregar os produtos agora.');
            });
    }
