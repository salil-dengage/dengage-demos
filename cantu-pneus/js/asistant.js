    ...
    assistantHeader.innerHTML = `
        <div class="assistant-header-content">
            ...
            <div class="assistant-header-text">
                <div class="assistant-header-title">Consultor CantuPneus</div>
                <div class="assistant-header-subtitle">Medidas, disponibilidade por filial e condições de pagamento.</div>
            </div>
            <div class="assistant-header-actions">
                ...
                <button class="assistant-close-btn" aria-label="Fechar">
    ...
    assistantContent.innerHTML = `
        <div class="assistant-content-wrapper">
            ...
            <div class="assistant-spotlight-section">
                <span class="assistant-eyebrow">Atendimento</span>
                <h3>Encontre a medida certa com a CantuPneus.</h3>
                <p>Consulte as linhas em estoque, simule uma carga fechada ou fale com um consultor sobre crédito para CNPJ.</p>
            </div>
        ...
        btn.addEventListener('click', function() {
            ...
            if (typeof window.dataLayer !== 'undefined') {
                window.dataLayer.push({
                    ...
                    widgetName: 'Consultor CantuPneus',
                    category: 'On Site Scenarios',
