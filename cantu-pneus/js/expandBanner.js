...
if (!document.querySelector("#min-bar-container")) {
    ...
    // Semana do Carreteiro, 25% na linha de carga
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "CARRETEIRO25",
      desktopImg: "images/scenes/hero-carga.jpg",
      mobileImg: "images/scenes/hero-carga.jpg",
      title: "Semana do Carreteiro",
      subtitle: "25% de desconto na linha de carga durante toda a semana.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      ...
      subtitle: "20% de desconto nas medidas de maior giro para frotas cadastradas.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      ...
      subtitle: "Frete CIF incluso no pedido de 72 unidades do Marshal KLD01.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      ...
      subtitle: "Conferência de DOT e alocação por centro de distribuição sem custo adicional.",
      href: null,
    });

    let MIN_BAR_CONFIG = [
      { text: "✦ CantuPneus Exclusive Offers", href: null, isInitMaxBar: true },
      { text: "Semana do Carreteiro: até 25% de desconto", href: null, isInitMaxBar: true },
      { text: "Frete CIF para pedidos de carga fechada", href: null, isInitMaxBar: true },
    ];
