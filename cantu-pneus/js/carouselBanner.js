...
function carouselBanner() {
  ...
  var defaultSlides = [
    {
      ...
      title: "Linha Carga",
      description: "Borrachudos, lisos direcionais e mistos para rodovia pesada e piso irregular.",
      alt: "Pneus de carga empilhados no centro de distribuição"
    },
    {
      image: "images/scenes/story-frota.jpg",
      title: "Marshal KLD01 295/80 R22.5",
      description: "Borrachudo Marshal KLD01 295/80 R22.5 com estoque em cinco centros de distribuição.",
      alt: "Pneu de passeio CantuPneus"
    },
    {
      image: "images/scenes/linha-agricola.jpg",
      title: "Linha Industrial e OTR",
      description: "Pá carregadeira, empilhadeira e OTR com carcaça reforçada para operação contínua.",
      alt: "Pneus industriais e OTR"
    },
    {
      image: "images/scenes/linha-carga.jpg",
      title: "Linha Carga",
      description: "Consultor dedicado para montar o pedido e conferir disponibilidade por filial.",
      alt: "Pneus de carga para caminhão"
    },
    {
      image: "images/scenes/linha-otr.jpg",
      title: "Statement Pieces",
      description: "Garra R1 e R1W para trator, colheitadeira e implemento, com estoque em todas as regiões.",
      alt: "Pneus agrícolas"
    },
    {
      image: "images/scenes/linha-agricola.jpg",
      title: "Linha Agrícola",
      description: "Simule a carga fechada, trave o preço e acompanhe a entrega direto pelo portal.",
      alt: "Pneus agrícolas para trator"
    }
  ];

  var config = {
    headerTitle: "CantuPneus Destaques da semana",
  ...
  function buildSlidesHTML(slides) {
    ...
    return slides
      .map(function (s) {
        var img = s.image || "";
        var alt = s.alt != null ? s.alt : "Destaque CantuPneus";
  ...
  function ensureDOM() {
    ...
    overlay.innerHTML =
      ...
      '<button class="cantupneus-carousel-close" aria-label="Fechar" type="button">&#10005;</button>' +
      '<div class="cantupneus-carousel-header">' + (config.headerTitle || "CantuPneus Destaques da semana") + "</div>" +
