...
function addIcon() {
    if (!document.querySelector("#dng-notification-container")) {
      ...
      const items = [
        {
          title: "Semana do Carreteiro: prévia",
          description: "Fale com um consultor para montar a carga fechada antes da abertura da campanha.",
          url: "#contact",
          icon: "gift",
          type: "buttons", // 2 butonlu tip
          buttons: [
            { text: "Falar com consultor", url: "#contact", primary: true },
            { text: "Ver linhas", url: "#collections", primary: false }
          ],
        ...
        },
        {
          ...
          description: "O novo lote do Marshal KLD01 295/80 R22.5 está liberado por tempo limitado.",
          url: "#collections",
          icon: "card",
        ...
        {
          title: "Frete grátis na carga fechada",
          description: "Simule a carga fechada e veja o frete CIF aplicado ao seu pedido.",
          url: "#contact",
          icon: "gift",
          type: "buttons", // 2 butonlu tip
          buttons: [
            { text: "Book Care", url: "#contact", primary: true },
            { text: "Ver detalhes", url: "#craftsmanship", primary: false }
          ],
          startDate: "Jan 01 2025 00:00",
          endDate: "Dec 31 2026 23:59",
        },
        {
          title: "Simulação de carga fechada",
          description: "Monte o pedido agrícola com apoio do consultor, do orçamento à entrega na fazenda.",
          url: "#contact",
          icon: "campus",
          type: "countdown", // Sayaçlı tip
        ...
        {
          title: "Ver linha agrícola",
          description: "Confira as medidas de passeio com maior giro e pronta entrega.",
          url: "#collections",
          icon: "card",
      ...
      header.innerHTML = `
        ...
        <button class="dng-close-btn" aria-label="Fechar">×</button>
      `;
      ...
      function createCountdown(countdownDate) {
        ...
        label.textContent = "A prévia termina em";
        ...
        function updateCountdown() {
          ...
          if (distance < 0) {
            timer.innerHTML = '<span style="color: #35015F; font-weight: 600;">Prévia encerrada</span>';
            return;
          }
