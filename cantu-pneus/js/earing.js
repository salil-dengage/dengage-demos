function earingWidget() {
    ...
    const config = {
        ...
        menuItems: [
            { text: "Ver catálogo", url: "#collections" },
            { text: "Destaques de carga", url: "#collections" },
            { text: "Qualidade", url: "#craftsmanship" },
            { text: "Nossa história", url: "#story" },
            { text: "Falar com um consultor", url: "#contact" }
        ],
        tabText: "Consultor CantuPneus",
