...
(function () {
    ...
    function initHeadBanner() {
        ...
        banner.innerHTML =
            ...
            '<span class="cantupneus-head-banner-badge">Oferta da semana</span>' +
            '<span class="cantupneus-head-banner-title">Semana do Carreteiro CantuPneus</span>' +
            '<span class="cantupneus-head-banner-text">Condições especiais em carga fechada e frete CIF para capitais atendidas.</span>' +
            '<a class="cantupneus-head-banner-link" href="#contact">Falar com consultor</a>' +
            "</div>" +
            '<button class="cantupneus-head-banner-close" type="button" aria-label="Fechar">&times;</button>';
