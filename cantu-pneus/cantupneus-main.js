...
if (loginForm) {
   loginForm.addEventListener('submit', event => {
      ...
      if (firstInvalidInput) {
         setSignupError('Preencha todos os campos para continuar.');
      ...
      try {
         ...
         console.error('Não foi possível salvar os dados do usuário no localStorage', err);
      }
