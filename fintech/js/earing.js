function earingWidget() {
    ...
    const config = {
        ...
        menuItems: [
            { text: "Compare products", url: "#collections" },
            { text: "Card highlights", url: "#collections" },
            { text: "Qualidade", url: "#craftsmanship" },
            { text: "About NovaPay", url: "#story" },
            { text: "Talk to a specialist", url: "#contact" }
        ],
        tabText: "NovaPay Specialist",
        tabColor: "#35015F", // NovaPay gold
    ...
    function setPosition(position) {
        if (position !== 'left' && position !== 'right') {
            console.warn('NovaPay concierge widget: position must be "left" or "right"');
            return;
        }
    ...
    function setMenuItems(items) {
        if (!Array.isArray(items)) {
            console.warn('NovaPay concierge widget: menuItems must be an array');
            return;
        }
