function sliderBanner() {
  ...
  const STYLE_ID = 'novapay-banner-slider-styles';
  const SECTION_ID = 'novapay-highlights-slider';
    ...
    const slides = [
      {
        ...
        desc: 'Up to 2% back on everything you buy, with no foreign exchange markup anywhere in the world.',
        cta: 'Compare cards',
        href: '#collections'
      },
      {
        image: 'images/scenes/scene-savings.svg',
        alt: 'NovaPay savings pots in the app',
        eyebrow: 'Saving and investing',
        title: '4.85% on your balance, paid daily',
        desc: 'Turn on Savings Boost and your whole balance earns interest, paid every day, with instant access and no limits.',
        cta: 'See savings products',
        href: '#collections'
      },
      {
        ...
        desc: 'A product specialist can compare tiers with you, model the fees against your spending and set the account up on the call.',
        ...
        <div class="banner-slide">
          ...
          <div class="banner-overlay">
            <div class="banner-text">
              ...
              <a class="banner-cta" href="${slide.href}" data-widget="NovaPay Highlights" data-slide="${slide.title}">
                ${slide.cta}
      ...
      <div class="container">
        <div class="slider-header">
          <div class="slider-header-content">
            <span class="section-subtitle">This month at NovaPay</span>
            <h2 class="h2 section-title">What our customers are opening</h2>
          </div>
      ...
      cta.addEventListener('click', function() {
        ...
        if (typeof window.dataLayer !== 'undefined') {
          window.dataLayer.push({
            ...
            widgetName: 'NovaPay Highlights Slider',
