function BottomAssistant() {
    ...
    assistantHeader.innerHTML = `
        <div class="assistant-header-content">
            ...
            <div class="assistant-header-text">
                <div class="assistant-header-title">NovaPay Specialist</div>
                <div class="assistant-header-subtitle">Fees, rates and which tier actually fits how you spend.</div>
            </div>
    ...
    assistantContent.innerHTML = `
        <div class="assistant-content-wrapper">
            ...
            <div class="assistant-spotlight-section">
                ...
                <h3>Find the right product with NovaPay.</h3>
                <p>Compare the card tiers, model the fees against your spending or ask about credit eligibility.</p>
            </div>
    ...
    // Styles - NovaPay gold/ivory theme
