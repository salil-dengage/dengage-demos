...
function addIcon() {
    if (!document.querySelector("#dng-notification-container")) {
      ...
      const items = [
        {
          title: "Launch offer: early access",
          description: "Open a card now and lock half-price for the first year before the offer goes public.",
          url: "#contact",
          icon: "gift",
          type: "buttons", // 2 butonlu tip
          buttons: [
            { text: "Claim the offer", url: "#contact", primary: true },
            { text: "Compare cards", url: "#collections", primary: false }
          ],
        ...
        },
        {
          ...
          description: "Applications for the Metal card are open again for a limited window.",
          url: "#collections",
          icon: "card",
        ...
        {
          title: "Fee waiver available",
          description: "Set up a salary deposit and we will waive your plan fee for a year.",
          url: "#contact",
          icon: "gift",
          type: "buttons", // 2 butonlu tip
          buttons: [
            { text: "Book Care", url: "#contact", primary: true },
            { text: "See how", url: "#craftsmanship", primary: false }
          ],
          startDate: "Jan 01 2025 00:00",
          endDate: "Dec 31 2026 23:59",
        },
        {
          ...
          description: "A specialist can review your portfolio mix and rebalance it with you.",
          url: "#contact",
          icon: "campus",
          type: "countdown", // Sayaçlı tip
        ...
        {
          title: "Book a review",
          description: "See the savings pots paying the highest rate right now.",
          url: "#collections",
          icon: "card",
      ...
      // İkon SVG'leri - NovaPay gold outline stilinde
      const iconSVGs = {
      ...
      function createCountdown(countdownDate) {
        ...
        label.textContent = "Early access ends in";
        ...
        function updateCountdown() {
          ...
          if (distance < 0) {
            timer.innerHTML = '<span style="color: #35015F; font-weight: 600;">Early access closed</span>';
            return;
          }
