(function () {
    ...
    function buildProductCard(product) {
        ...
        const oldPrice = Number(product.oldPrice) > Number(product.price)
            ...
            : '';
        const detailUrl = window.NovaPayCatalogData
            ? window.NovaPayCatalogData.buildProductUrl(product.id)
    ...
    function render(currentProduct) {
        if (!window.NovaPayCatalogData) return;

        window.NovaPayCatalogData.loadProducts()
            .then(function (allProducts) {
                ...
                const subtitle = categoryLabel
                    ...
                    : 'More from the same product line';
    ...
    window.addEventListener('novapay:product:loaded', function (event) {
