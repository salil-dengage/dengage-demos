...
var DENGAGE_PRIZE_CODE = (currentScript && currentScript.dataset && currentScript.dataset.dengageCode) || 'NOVA-BOOST-2026';
...
<div id="dengage-modal" role="document">\
  <header id="dengage-header">\
    <h1 class="dengage-title">NovaPay Reveal: uncover your reward</h1>\
    <p class="dengage-description">Scratch to reveal your NovaPay code and unlock the reward on your account.</p>\
  </header>\
...
// fill overlay (to be scratched away) - NovaPay gold gradient
...
function WheelGame() {
	...
	if (!document.getElementById('dng-cjs-game-form')) {
		var style = '<style id="dng-cjs-wheel-first-step">#dng-cjs-game-form-overlay{transform: translate3d(0 , 0 , 3px);z-index: 1000000001!important;position: fixed; left: 0px; top: 0px; width: 100%; height: 100%; background-color: rgba(28, 28, 28, 0.55);}\
			...
			#dng-cjs-wheel-content{width:310px;right:30px;position:absolute;height:100%}\
			...
			#dng-cjs-text-bold{font-family:"Barlow Condensed",Georgia,serif;font-weight:600;font-size:32px;top:80px;letter-spacing:0.02em;}\
			#dng-cjs-text-normal{font-weight:400;font-size:15px;top:150px;line-height:1.45;width:90%;}\
			.dng-cjs-text{text-align:center;position:absolute;left:0;right:0;margin:auto; color: #F6F4FA}\
			.dng-cjs-spin-button{background:#F6F4FA;color:#1A1030;position: absolute;cursor: pointer;right:0;left:0;margin:auto;bottom: 95px;width: 160px;height: 44px; border:1px solid #4E018F;border-radius:999px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;font-size:13px;transition:background 0.2s ease,color 0.2s ease;}\
			.dng-cjs-spin-button:hover{background:#1A1030;color:#4E018F;}\
			@media only screen and (max-width: 700px) {\
				#dng-cjs-game-form{width: 300px; height: 460px; background: linear-gradient(180deg, #1A1030 0%, #3A3A3A 55%, #35015F 100%);}\
				#dng-cjs-form-close{top:3px;right:3px}\
				#dng-cjs-wheel-container{width:100%;height:240px;left:0;right:0;margin:auto;top:0}\
				#dng-cjs-wheel-content{width:100%;height:180px;left:0;right:0;margin:auto;top:255px}\
				#dng-cjs-text-bold{font-size:24px;top:0px}\
				#dng-cjs-text-normal{font-size:13px;top:38px;width:88%;}\
				#wheel{width: 235px; top: 18px; left: 0; right: 0; margin:auto;}\
				#tick{top:5px;}\
				.dng-cjs-spin-button{bottom: 18px;width: 150px;height: 40px;font-size:12px}\
			}\
			</style>';
		var html = '<div id="dng-cjs-game-form-overlay"></div><div id="dng-cjs-game-form">\
			<button id="dng-cjs-form-close" style="position: absolute; width:auto; right: 0px; top: 0px; border: 0px; color: #fff; padding: 5px 10px; cursor: pointer; font-size: 29px; transition: all 1s ease 0s; border-radius: 10px; background-color: rgba(0, 0, 0, 0); z-index: 999; transform: translate3d(0px, 0px, 3px);">✖</button>\
    			...
    			<div id="dng-cjs-wheel-content">\
    				<div id="dng-cjs-text-bold" class="dng-cjs-text">Spin for a NovaPay reward</div>\
    				<div id="dng-cjs-text-normal" class="dng-cjs-text">Spin to win a cashback boost, a fee waiver or bonus interest.</div>\
		...
		function finalize(coupon, text, link) {
			var style = '<style>#dng-cjs-wheel-container{opacity:0.7}\
				#dng-cjs-result-title{font-family:"Barlow Condensed",Georgia,serif;font-size:30px;font-weight:600;top:25px;letter-spacing:0.02em;color:#F6F4FA;}\
				#dng-cjs-result-text{font-size: 14px;font-weight:500;width: 92%;top: 78px;text-align: center;color:#F6F4FA;line-height:1.45;}\
				#dng-cjs-result-label{font-size:11px;width:80%;top:140px;color:rgba(255,251,245,0.78);}\
				#dng-cjs-wheelCouponCode{border: 2px dashed #4E018F;outline:none; background: rgba(255,251,245,0.08);position: absolute;top:175px;right: 0;left:0;margin:auto;font-weight:800;text-align: center;width: 175px;font-size: 18px;color:#F6F4FA;padding:10px;border-radius:10px;letter-spacing:0.18em;}\
				#dng-cjs-wheelCopyButton{position:absolute;cursor:pointer;right:0;left:0;margin:auto;top:240px;width:200px;background:#F6F4FA;color:#1A1030;font-weight:700;border-radius:999px;text-align:center;padding:9px;font-size:12px;letter-spacing:0.12em;text-transform:uppercase;border:1px solid #4E018F;}\
				#dng-cjs-wheelCopyButton:hover{background:#1A1030;color:#4E018F;}\
				#dng-cjs-label{font-size: 9px; bottom: 56px;color:rgba(255,251,245,0.65);}\
				#dng-cjs-label-2{font-size:9px;bottom:28px;width:95%;color:rgba(255,251,245,0.65);}\
				@media only screen and (max-width: 500px) {\
					#dng-cjs-wheel-container{display:none}\
					#dng-cjs-wheel-content{height:100% !important; top: 0 !important}\
					#dng-cjs-result-title{font-size:24px;top: 24px;}\
					#dng-cjs-result-text{top: 70px;font-size: 13px;width:80%}\
					#dng-cjs-result-label{top:128px;font-size:11px}\
					#dng-cjs-wheelCouponCode{top:170px;height:45px;width:160px;font-size:16px}\
					#dng-cjs-wheelCopyButton{top:240px;width: 180px;font-size:11px;padding: 9px;}\
					#dng-cjs-label{font-size: 9px; bottom: 70px;}\
					#dng-cjs-label-2{font-size:9px;bottom:34px;width:80%}\
				}\
				</style>';
			document.head.insertAdjacentHTML('beforeend', style);
			...
			dngWheelContent.insertAdjacentHTML('beforeend', '<div id="dng-cjs-result-label" class="dng-cjs-text">Apply the code in the app before December 31.</div>');
			...
			dngWheelContent.insertAdjacentHTML('beforeend', '<div id="dng-cjs-label-2" class="dng-cjs-text">*Applies to the plan fee on eligible NovaPay products.</div>');
			...
			function WheelGame() {
				var spinTheWheel = function () {
					wheel.spin(function (valueSpun) {
						...
						if (valueSpun == "1000 Pontos NovaPay") {
							coupon = "NOVA1000PTS";
							text = "You won 1,000 NovaPay reward points, usable against any plan fee.";
							link = "#collections";
						}
						else if (valueSpun == "Fee waiver") {
							coupon = "NOVAFEEWAIVER";
							text = "You won a 12-month fee waiver on your next product.";
							link = "#contact";
						}
						else if (valueSpun == "Vale $ 250") {
							coupon = "NOVA250USD";
							text = "You won $250 credited to your NovaPay balance.";
							link = "#collections";
						}
						else if (valueSpun == "Frota Platinum") {
							coupon = "NOVAMETALYEAR";
							text = "You unlocked NovaPay Metal for a year, on us.";
							link = "#contact";
						}
						else if (valueSpun == "Tabela Antecipada") {
							coupon = "NOVAEARLYACCESS";
							text = "You secured early access to our next investing product.";
							link = "#collections";
						}
						else if (valueSpun == "Brinde Surpresa") {
							coupon = "NOVAPERK";
							text = "You won a surprise NovaPay perk on your next statement.";
							link = "#contact";
						}
						else {
							alert(valueSpun);
...
<div class="tinder--status">
  ...
  <div class="tinder--cards">
    <div data-id="cards" class="tinder--card">
     <img src="images/scenes/hero-cards.svg" alt="Cards">
     <div class="tinder--card-label">
       <span class="eyebrow">Cards</span>
       <span class="title">NovaPay Metal Card</span>
     </div>
    </div>
    <div data-id="recap" class="tinder--card">
     <img src="images/scenes/scene-team.svg" alt="NovaPay Metal Card">
     <div class="tinder--card-label">
    ...
    <div data-id="heritage" class="tinder--card">
     <img src="images/scenes/hero-invest.svg" alt="Protection">
     <div class="tinder--card-label">
       <span class="eyebrow">NovaPay Rewards</span>
       <span class="title">NovaPay Plus Card</span>
     </div>
    </div>
    <div data-id="statement" class="tinder--card">
     <img src="images/scenes/scene-vault.svg" alt="Savings">
     <div class="tinder--card-label">
       <span class="eyebrow">Agricultural Line</span>
       <span class="title">Managed Portfolio</span>
     </div>
    </div>
 </div>
...
code="NOVA-BOOST";
title="NovaPay Metal Card saved to your shortlist";
subtitle="We will let you know the moment applications reopen.";
break;
case "recap":
image="images/scenes/scene-team.svg";
code="NOVA-METAL";
title="NovaPay Metal Card saved to favourites";
subtitle="Get our new rates before everyone else.";
break;
case "heritage":
image="images/scenes/hero-invest.svg";
code="NOVA-BOOST";
title="Managed Portfolio noted for you";
subtitle="A NovaPay specialist will walk you through the portfolio options.";
break;
case "statement":
image="images/scenes/scene-vault.svg";
code="NOVA-PORTFOLIO";
title="Goal Pots Pro saved";
subtitle="See more products with launch pricing.";
break;
default:
image="images/scenes/hero-cards.svg";
code="NOVA-PERK";
title="A NovaPay offer is waiting on your account";
subtitle="Open the app to claim it before it expires.";
}
...
<div class="dng-cjs-likecard-body">
  <span class="dng-cjs-likecard-eyebrow">NovaPay</span>
  ...
  <div class="dng-cjs-likecard-actions">
    <button class="dng-cjs-likecard-givecode" type="button">Reveal my offer</button>
    <button class="dng-cjs-likecard-tryagain" type="button">Maybe later</button>
  </div>
</div>
</div>
`;
