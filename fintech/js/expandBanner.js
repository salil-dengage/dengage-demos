...
if (!document.querySelector("#min-bar-container")) {
    ...
    // Launch month, the card range
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "CARRETEIRO25",
      desktopImg: "images/scenes/hero-cards.svg",
      mobileImg: "images/scenes/hero-cards.svg",
      title: "Launch month",
      subtitle: "50% off the first year on any card tier.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "NOVAPAYFROTA20",
      desktopImg: "images/scenes/scene-savings.svg",
      mobileImg: "images/scenes/scene-savings.svg",
      title: "Campanha Frotista",
      subtitle: "Double reward points on every purchase this month.",
      href: null,
    });

    // NovaPay Metal Card, limited release
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "NOVAPAY-LAUNCH",
      desktopImg: "images/scenes/hero-invest.svg",
      mobileImg: "images/scenes/hero-invest.svg",
      title: "NovaPay Metal Card, limited release",
      subtitle: "Metal card fee waived when you set up a salary deposit.",
      href: null,
    });
    ...
    MAX_BAR_CONFIG.push({
      ...
      desktopImg: "images/scenes/hero-invest.svg",
      mobileImg: "images/scenes/hero-invest.svg",
      title: "Fee waived on Metal",
      subtitle: "An extra 1% on any pot opened before the end of the month.",
      href: null,
    });

    let MIN_BAR_CONFIG = [
      { text: "✦ NovaPay Exclusive Offers", href: null, isInitMaxBar: true },
      { text: "Launch month: first year half price", href: null, isInitMaxBar: true },
      { text: "Bonus interest on new pots", href: null, isInitMaxBar: true },
    ];
    ...
    function initMaxBar() {
      ...
      for (let el = 0; el < MAX_BAR_CONFIG.length; el++) {
        ...
        const altText = currentElement.title || "Campanha NovaPay";
          ...
          if (e.target.classList.contains("dng-max-copy-btn")) {
            ...
            if (typeof window.dataLayer !== 'undefined') {
              window.dataLayer.push({
                ...
                widgetName: 'NovaPay Expand Banner',
    ...
    function addActionStyles() {
      ...
      :root {
        --novapay-gold: #4E018F;
        --novapay-gold-light: #4E018F;
        --novapay-gold-dark: #35015F;
        --novapay-charcoal: #1A1030;
        --novapay-cream: #F6F4FA;
        --novapay-ivory: #EDE9F5;
      }
      ...
      #max-bar-container {
        ...
        position: fixed;
        z-index: 1000000;
        background-color: var(--novapay-cream);
        font-family: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
        color: var(--novapay-charcoal);
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
      ...
      .dng-max-copy-btn{
        ...
        border: 1px solid var(--novapay-cream);
        box-shadow: 0 6px 16px rgba(28, 28, 28, 0.25);
        z-index: 3;
        transition: background 0.2s ease, color 0.2s ease;
      }
      .dng-max-copy-btn:hover{
        background: var(--novapay-gold-dark);
        color: var(--novapay-cream);
        border-color: var(--novapay-gold-dark);
      }
      .dng-max-copy-btn--copied{
        background: var(--novapay-gold);
        color: var(--novapay-cream);
        border-color: var(--novapay-gold);
      }
      ...
      .dng-min-bar-swiper-container {
       ...
       .dng-min-bar-swiper-container .swiper-wrapper .swiper-slide a:hover { color: var(--novapay-cream); }
