...
if (!document.querySelector("#min-bar-container")) {
    ...
    // Rate week, 25% na linha de carga
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "MERIDIANRATEWEEK",
      desktopImg: "images/scenes/hero-branch.svg",
      mobileImg: "images/scenes/hero-branch.svg",
      title: "Rate week",
      subtitle: "Product fees waived on every mortgage this week.",
      href: null,
    });

    // Bonus rate on new fixed rate savers
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "MERIDIANSAVER25",
      desktopImg: "images/scenes/scene-advisor.svg",
      mobileImg: "images/scenes/scene-advisor.svg",
      title: "Savings rate boost",
      subtitle: "An extra 0.25% AER on new fixed rate savers.",
      href: null,
    });

    // Remortgage: legal work and valuation covered
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "MERIDIANREMO",
      desktopImg: "images/scenes/hero-wealth.svg",
      mobileImg: "images/scenes/hero-wealth.svg",
      title: "Remortgage to Meridian",
      subtitle: "Legal fees and valuation covered on any remortgage.",
      href: null,
    });

    // Mortgage product fees waived
    MAX_BAR_CONFIG.push({
      type: "banner",
      coupon: "MERIDIANFEEFREE",
      desktopImg: "images/scenes/hero-wealth.svg",
      mobileImg: "images/scenes/hero-wealth.svg",
      title: "Mortgage fees waived",
      subtitle: "Standard valuation and legal work included at no cost.",
      href: null,
    });

    let MIN_BAR_CONFIG = [
      { text: "✦ Meridian Exclusive Offers", href: null, isInitMaxBar: true },
      { text: "Rate week: mortgage fees waived", href: null, isInitMaxBar: true },
      { text: "Bonus rate on fixed savers", href: null, isInitMaxBar: true },
    ];
    ...
    function initMaxBar() {
      ...
      for (let el = 0; el < MAX_BAR_CONFIG.length; el++) {
        ...
        const altText = currentElement.title || "Campanha Meridian";
          ...
          if (e.target.classList.contains("dng-max-copy-btn")) {
            ...
            if (typeof window.dataLayer !== 'undefined') {
              window.dataLayer.push({
                ...
                widgetName: 'Meridian Expand Banner',
    ...
    function addActionStyles() {
      ...
      :root {
        --meridian-gold: #4E018F;
        --meridian-gold-light: #4E018F;
        --meridian-gold-dark: #35015F;
        --meridian-charcoal: #1A1030;
        --meridian-cream: #F6F4FA;
        --meridian-ivory: #EDE9F5;
      }
      ...
      #max-bar-container {
        ...
        position: fixed;
        z-index: 1000000;
        background-color: var(--meridian-cream);
        font-family: "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
        color: var(--meridian-charcoal);
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
      ...
      .dng-max-copy-btn{
        ...
        border: 1px solid var(--meridian-cream);
        box-shadow: 0 6px 16px rgba(28, 28, 28, 0.25);
        z-index: 3;
        transition: background 0.2s ease, color 0.2s ease;
      }
      .dng-max-copy-btn:hover{
        background: var(--meridian-gold-dark);
        color: var(--meridian-cream);
        border-color: var(--meridian-gold-dark);
      }
      ...
      .dng-min-bar-swiper-container {
       ...
       .dng-min-bar-swiper-container .swiper-wrapper .swiper-slide a:hover { color: var(--meridian-cream); }
