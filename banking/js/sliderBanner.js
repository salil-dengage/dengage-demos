function sliderBanner() {
  ...
  const STYLE_ID = 'meridian-banner-slider-styles';
  const SECTION_ID = 'meridian-highlights-slider';
  ...
  const anchor =
    document.querySelector('.rate-board') ||
  ...
  if (!anchor) {
    console.warn('sliderBanner: no .rate-board or .featured-piece anchor found, slider will not be inserted');
    return;
  }
    ...
    const slides = [
      {
        ...
        eyebrow: 'Mortgages',
        title: 'First home, five-year certainty',
        desc: 'A five-year fixed rate for first-time buyers, deposits from 5%, and the standard valuation paid by us.',
        cta: 'See mortgage rates',
        href: '#products'
      },
      {
        image: 'images/scenes/scene-advisor.svg',
        alt: 'Meridian savings and ISAs',
        eyebrow: 'Savings and ISAs',
        title: '4.80% AER, fixed for two years',
        desc: 'Lock your rate for one, two or three years, with the return guaranteed for the whole term and transfers in handled by us.',
        cta: 'See savings rates',
        href: '#products'
      },
      {
        image: 'images/scenes/hero-wealth.svg',
        alt: 'A Meridian adviser appointment',
        eyebrow: 'Named advisers',
        title: 'Sit down with an adviser',
        desc: 'Mortgages, wealth and business banking come with a named adviser, in branch, by video or over the phone within three working days.',
        ...
        <div class="banner-slide">
          ...
          <div class="banner-overlay">
            <div class="banner-text">
              ...
              <a class="banner-cta" href="${slide.href}" data-widget="Meridian Highlights" data-slide="${slide.title}">
                ${slide.cta}
      ...
      <div class="container">
        <div class="slider-header">
          <div class="slider-header-content">
            <span class="section-subtitle">This month at Meridian</span>
            <h2 class="h2 section-title">What our customers are applying for</h2>
          </div>
      ...
      cta.addEventListener('click', function() {
        ...
        if (typeof window.dataLayer !== 'undefined') {
          window.dataLayer.push({
            ...
            widgetName: 'Meridian Highlights Slider',
