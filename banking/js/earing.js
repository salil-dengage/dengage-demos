function earingWidget() {
    ...
    const config = {
        ...
        menuItems: [
            { text: "See products", url: "#collections" },
            { text: "Mortgage highlights", url: "#collections" },
            { text: "Qualidade", url: "#craftsmanship" },
            { text: "About Meridian", url: "#story" },
            { text: "Book an adviser", url: "#contact" }
        ],
        tabText: "Meridian Adviser",
        tabColor: "#35015F", // Meridian gold
    ...
    function setPosition(position) {
        if (position !== 'left' && position !== 'right') {
            console.warn('Meridian concierge widget: position must be "left" or "right"');
            return;
        }
    ...
    function setMenuItems(items) {
        if (!Array.isArray(items)) {
            console.warn('Meridian concierge widget: menuItems must be an array');
            return;
        }
