...
function addIcon() {
    if (!document.querySelector("#dng-notification-container")) {
      ...
      const items = [
        {
          title: "Rate week: early notice",
          description: "Speak to an adviser and lock this week's rate before it changes.",
          url: "#contact",
          icon: "gift",
          type: "buttons", // 2 butonlu tip
          buttons: [
            { text: "Book an adviser", url: "#contact", primary: true },
            { text: "See rates", url: "#collections", primary: false }
          ],
          startDate: "Jan 01 2025 00:00",
          endDate: "Dec 31 2026 23:59",
        },
        {
          title: "Meridian Infinite Card: limited release",
          description: "The new Meridian Infinite Card batch is available for a limited time.",
          url: "#collections",
          icon: "card",
        ...
        },
        {
          ...
          description: "Check what you could borrow in two minutes, with no credit-score impact.",
          url: "#contact",
          icon: "gift",
          type: "buttons", // 2 butonlu tip
          buttons: [
            { text: "Book Care", url: "#contact", primary: true },
            { text: "Check now", url: "#craftsmanship", primary: false }
          ],
          startDate: "Jan 01 2025 00:00",
          endDate: "Dec 31 2026 23:59",
        },
        {
          ...
          description: "Your adviser can review your portfolio and rebalance it with you.",
          url: "#contact",
          icon: "campus",
          type: "countdown", // Sayaçlı tip
        ...
        {
          title: "Book a review",
          description: "See which savings accounts are paying the most right now.",
          url: "#collections",
          icon: "card",
      ...
      // İkon SVG'leri - Meridian gold outline stilinde
      const iconSVGs = {
      ...
      function createCountdown(countdownDate) {
        ...
        label.textContent = "This rate ends in";
        ...
        function updateCountdown() {
          ...
          if (distance < 0) {
            timer.innerHTML = '<span style="color: #35015F; font-weight: 600;">Rate withdrawn</span>';
            return;
          }
