function BottomAssistant() {
    ...
    assistantHeader.innerHTML = `
        <div class="assistant-header-content">
            ...
            <div class="assistant-header-text">
                <div class="assistant-header-title">Meridian Adviser</div>
                <div class="assistant-header-subtitle">Rates, eligibility and what the monthly payment would be.</div>
            </div>
    ...
    assistantContent.innerHTML = `
        <div class="assistant-content-wrapper">
            ...
            <div class="assistant-spotlight-section">
                ...
                <h3>Find the right product with Meridian.</h3>
                <p>Compare our accounts, check what you could borrow, or book time with an adviser.</p>
            </div>
    ...
    // Styles - Meridian gold/ivory theme
