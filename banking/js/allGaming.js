...
var DENGAGE_PRIZE_CODE = (currentScript && currentScript.dataset && currentScript.dataset.dengageCode) || 'MERIDIAN-2026';
...
<div id="dengage-modal" role="document">\
  <header id="dengage-header">\
    <h1 class="dengage-title">Meridian Reveal: Uncover Your Reward</h1>\
    <p class="dengage-description">Scratch to reveal your Meridian code and claim the reward on your account.</p>\
  </header>\
...
// fill overlay (to be scratched away) - Meridian gold gradient
...
function WheelGame() {
	...
	if (!document.getElementById('dng-cjs-game-form')) {
		...
		var html = '<div id="dng-cjs-game-form-overlay"></div><div id="dng-cjs-game-form">\
			<button id="dng-cjs-form-close" style="position: absolute; width:auto; right: 0px; top: 0px; border: 0px; color: #fff; padding: 5px 10px; cursor: pointer; font-size: 29px; transition: all 1s ease 0s; border-radius: 10px; background-color: rgba(0, 0, 0, 0); z-index: 999; transform: translate3d(0px, 0px, 3px);">✖</button>\
    			...
    			<div id="dng-cjs-wheel-content">\
    				<div id="dng-cjs-text-bold" class="dng-cjs-text">Spin for a Meridian reward</div>\
    				<div id="dng-cjs-text-normal" class="dng-cjs-text">Spin to win a fee refund, bonus interest or reward points.</div>\
		...
		function finalize(coupon, text, link) {
			...
			dngWheelContent.insertAdjacentHTML('beforeend', '<div id="dng-cjs-result-label" class="dng-cjs-text">Quote the code to your adviser before December 31.</div>');
			...
			dngWheelContent.insertAdjacentHTML('beforeend', '<div id="dng-cjs-label-2" class="dng-cjs-text">*Applies to eligible Meridian products only.</div>');
			...
			function WheelGame() {
				var spinTheWheel = function () {
					wheel.spin(function (valueSpun) {
						...
						if (valueSpun == "1,000 Meridian Points") {
							coupon = "MERIDIAN1000PTS";
							text = "You won 1,000 Meridian reward points.";
							link = "#products";
						}
						else if (valueSpun == "Fee refund") {
							coupon = "MERIDIANFEEFREE";
							text = "You won your account fee refunded for 12 months.";
							link = "#appointments";
						}
						else if (valueSpun == "£250 cashback") {
							coupon = "MERIDIAN250GBP";
							text = "You won £250 paid into your Meridian account.";
							link = "#products";
						}
						else if (valueSpun == "Premier upgrade") {
							coupon = "MERIDIANPREMIER";
							text = "You have been upgraded to a Premier Account for a year.";
							link = "#appointments";
						}
						else if (valueSpun == "Early rate access") {
							coupon = "MERIDIANEARLY";
							text = "You secured early access to our next savings rate.";
							link = "#products";
						}
						else if (valueSpun == "Surprise reward") {
							coupon = "MERIDIANREWARD";
							text = "You won a surprise Meridian reward on your next statement.";
							link = "#appointments";
						}
						else {
							alert(valueSpun);
...
<div class="tinder--status">
  ...
  <div class="tinder--cards">
    <div data-id="carga" class="tinder--card">
     <img src="images/scenes/hero-branch.svg" alt="Current accounts">
     <div class="tinder--card-label">
       <span class="eyebrow">Cards</span>
       <span class="title">Meridian Infinite Card</span>
     </div>
    </div>
    <div data-id="recap" class="tinder--card">
     <img src="images/scenes/hero-branch.svg" alt="Meridian Infinite Card">
     <div class="tinder--card-label">
    ...
    <div data-id="heritage" class="tinder--card">
     <img src="images/scenes/hero-wealth.svg" alt="Insurance">
     <div class="tinder--card-label">
       <span class="eyebrow">Meridian Rewards</span>
       <span class="title">Meridian Platinum Card</span>
     </div>
    </div>
    <div data-id="statement" class="tinder--card">
     ...
     <div class="tinder--card-label">
       ...
       <span class="title">Wealth Portfolio</span>
     </div>
    </div>
 </div>
...
switch (imagetype) {
case "carga":
image="images/scenes/hero-branch.svg";
code="MERIDIAN-REWARD";
title="Meridian Infinite Card saved to your shortlist";
subtitle="We will let you know the moment the rate changes.";
break;
case "recap":
image="images/scenes/hero-branch.svg";
code="MRD-INFINITE";
title="Meridian Infinite Card saved to favourites";
subtitle="Get our new savings rates before everyone else.";
break;
case "heritage":
image="images/scenes/hero-wealth.svg";
code="MRD-SAVER";
title="Fixed Rate Saver noted for you";
subtitle="A Meridian adviser will talk you through the terms.";
break;
case "statement":
image="images/scenes/scene-vault.svg";
code="MRD-WEALTH";
title="Cash ISA saved";
subtitle="See more products with preferential rates.";
break;
default:
image="images/scenes/hero-cards.svg";
code="MRD-GIFT";
title="A Meridian offer is waiting on your account";
subtitle="Sign in to online banking to claim it.";
}
...
<div class="dng-cjs-likecard-body">
  <span class="dng-cjs-likecard-eyebrow">Meridian</span>
